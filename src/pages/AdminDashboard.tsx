      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Azure, Microsoft 365, DevOps</p>
          </CardContent>
        </Card>
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center justify-between border-b pb-3">
                  <div>
                    <p className="font-medium">{`The Ultimate Guide to Build Your Custom AI Server`}</p>
                    <p className="text-sm text-muted-foreground">Azure</p>
                  </div>
                  <div className="text-sm text-muted-foreground">May {6 - i}, 2023</div>
                </div>
              ))}
            </div>
          </CardContent>
